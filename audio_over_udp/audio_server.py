...
listening_sock.bind(("0.0.0.0", config.Client.SERVER_PORT))
...
t1.daemon = False
t1.start()
t2 = threading.Thread(target=audio_functions.send_audio, args=(AUDI0_INPUT_STREAM, sending_sock, "SERVER",))
t2.daemon = False
t2.start()
